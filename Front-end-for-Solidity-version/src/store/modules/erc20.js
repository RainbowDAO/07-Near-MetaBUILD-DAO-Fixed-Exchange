...
const actions = {
    allowance({rootState}, {owner, spender,coinAddress}) {
    ...
    approve({rootState}, {spender, amount,coinAddress}) {
          judgeToken(rootState,coinAddress)
        return new Promise((resolve, reject) => {
    ...
    balanceOf({rootState}, {account,coinAddress}) {
        console.log(account,coinAddress)
          judgeToken(rootState,coinAddress)
        return new Promise((resolve, reject) => {
    ...
    decimals({rootState},{coinAddress}) {
          judgeToken(rootState,coinAddress)
        return new Promise((resolve, reject) => {
    ...
    decreaseAllowance({rootState}, {spender, subtractedValue,coinAddress}) {
          judgeToken(rootState,coinAddress)
        return new Promise((resolve, reject) => {
    ...
    increaseAllowance({rootState}, {spender, addedValue,coinAddress}) {
          judgeToken(rootState,coinAddress)
        return new Promise((resolve, reject) => {
    ...
    totalSupply({rootState},{coinAddress}) {
          judgeToken(rootState,coinAddress)
        return new Promise((resolve, reject) => {
    ...
    transfer({rootState}, {recipient, amount,coinAddress}) {
          judgeToken(rootState,coinAddress)
        return new Promise((resolve, reject) => {
    ...
    transferFrom({rootState}, {sender, recipient, amount,coinAddress}) {
          judgeToken(rootState,coinAddress)
        return new Promise((resolve, reject) => {
